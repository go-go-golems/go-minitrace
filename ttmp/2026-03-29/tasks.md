...
- [x] Decide query workflow shape for `go-minitrace`
- [x] Add `queries/` folder with reusable DuckDB loading flow
- [x] Add query README and representative SQL recipes
- [x] Test the queries against a converted sample archive
- [x] Update diary/docs to reflect the new query workflow
- [x] Commit the query workflow checkpoint
