...
- [x] Inventory adapter surface area and fidelity claims
- [x] Study agentsview parser/provider architecture for comparable transcript handling patterns
- [x] Build a real-transcript sample corpus for each supported source type
- [x] Create redaction-safe source-shape summaries for each corpus sample
- [x] Convert the corpus with current go-minitrace adapters and capture diagnostics
