...
- [ ] Phase 1: add serve command package and register go-minitrace serve in the root CLI
- [ ] Phase 1: build a startup session index from --archive-glob and thread it into the server
- [ ] Phase 1: implement server skeleton plus POST /api/query with structured 200/400 JSON responses
