...
const { decodeSessionBlocks } = await import(pathToFileURL(resolve(repo, 'web/src/api/sessionProtoAdapters.ts')));
const wire = JSON.parse(readFileSync(0, 'utf8'));
const calls = decodeSessionBlocks(wire)[0].turns[0].tool_calls_in_turn;
